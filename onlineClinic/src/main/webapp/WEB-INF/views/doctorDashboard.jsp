                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <%
                                    // Fetch the doctor's name from the session
                                    String doctorName = (String) session.getAttribute("docname");
                                %>
                                <h3 class="card-title">Hello, <%= doctorName %></h3>
                                <a href="viewDocpatients" class="btn btn-primary w-100 fs-4 mb-4 rounded-2">View All Patients</a>
                            </div>
                        </div>
                    </div>
                </div>
