...
<head>
  ...
  <title>HealthHub-Doctors Login</title>
          ...
          <div class="col-md-8 col-lg-6 col-xxl-3">
            <div class="card mb-0">
              <div class="card-body">
                ...
                <form action="processdoclogin" method="post">
                  <div class="mb-3">
                    <label for="demail" class="form-label">Username</label>
                    <input type="email" class="form-control" id="demail" name="demail" aria-describedby="emailHelp">
                  </div>
                  <div class="mb-4">
                  ...
                  <div class="d-flex align-items-center justify-content-between mb-4">
                    ...
                    <a class="text-primary fw-bold" href="newDoc">New User?</a>
                  </div>
